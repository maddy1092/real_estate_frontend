<template>
  <div class="SuspendedResumedContract">
                ...
                >
                  <template v-slot:items="props">
                    ...
                    >
                      ...
                      <td class="text-xs-center">
                        {{
                          props.item.is_suspended
                            ? $t("Suspended")
                            : $t("Resumed")
                        }}
                      </td>
                      <td class="text-xs-center">
                        {{ props.item.reference ? props.item.reference : "-" }}
                      </td>
                      <td>
                        <div
...
import ContractListFilter from "../views/contracts/List/ContractListFilter";
import TableLoader from "../views/loaders/TableLoader";

import breadItemsSetLang from "@/mixins/breadItemsSetLang";

export default {
  name: "SuspendedResumeContract",
  components: { ContractDialogue, TableLoader, ContractListFilter },
  ...
  computed: {
    ...
    pages() {
      if (!this.pagination.rowsPerPage || !this.pagination.totalItems) return 0;
...
::v-deep .most-inner-datatable td {
  padding: 0px;
}
</style>
